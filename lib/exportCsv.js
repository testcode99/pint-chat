...
function main() {
    ...
    writeCsv('user_stats.csv',
        ['rank', 'user', 'phone_number', 'total_posts', 'percentage_of_total', 'longest_streak', 'streak_start', 'streak_end', 'current_streak', 'posts_today', 'posts_this_week', 'posts_this_month', 'first_post_date', 'last_post_date', 'unique_days_posted', 'busiest_hour', 'busiest_day'],
    ...
    writeCsv('leaderboard.csv',
        ['rank', 'user', 'phone_number', 'posts', 'streak'],
